// "Shop by Type" mega menu panel. Markup mirrors the original WordPress block output so the theme CSS applies unchanged.
import BlockSearch from '../BlockSearch'

export default function MegaMenuShopByType() {
  return (
    <>
      <div className="wp-block-cover alignwide has-base-color has-text-color has-link-color has-campton-font-family wp-elements-14" style={{ marginTop: "0", marginBottom: "0", paddingTop: "var(--wp--preset--spacing--50)", paddingRight: "var(--wp--preset--spacing--10)", paddingBottom: "var(--wp--preset--spacing--50)", paddingLeft: "var(--wp--preset--spacing--10)", boxShadow: "var(--wp--preset--shadow--medium-dark)" }}>
        ...
        <span aria-hidden="true" className="wp-block-cover__background has-background-dim" style={{ backgroundColor: "#1e439b" }} />
        <div className="wp-block-cover__inner-container is-layout-constrained wp-container-core-cover-is-layout-b4b20876 wp-block-cover-is-layout-constrained">
          <BlockSearch id="wp-block-search__input-10" placeholder="Search all products..." buttonClassName="wp-block-search__button has-icon wp-element-button" wrapperStyle={{ width: "100%" }} />
          <h3 className="wp-block-heading" id="h-shop-by-type" style={{ paddingTop: "0", paddingBottom: "0", lineHeight: "1" }}>
            Shop by Type
          </h3>
          <div className="wp-block-group cb-type-row has-base-color has-text-color has-link-color wp-elements-15 is-layout-grid wp-container-core-group-is-layout-a95b5d41 wp-block-group-is-layout-grid" style={{ fontStyle: "normal", fontWeight: "500" }}>
            <div className="wp-block-group is-style-background-blur cb-has-abs-link is-vertical is-content-justification-center is-layout-flex wp-container-core-group-is-layout-135ecd20 wp-block-group-is-layout-flex" style={{ paddingTop: "var(--wp--preset--spacing--20)", paddingRight: "var(--wp--preset--spacing--20)", paddingBottom: "var(--wp--preset--spacing--20)", paddingLeft: "var(--wp--preset--spacing--20)" }}>
              <figure className="wp-block-image size-thumbnail has-custom-border is-style-rounded-full is-style-default">
